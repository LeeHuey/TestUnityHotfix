...
public static class BuildDLLCommand
{
    ...
    //@TODO: 临时使用，需要定义在常量文件中管理
    public static string AssemblyTextAssetPath = "GameRes/DLL";
    
    //@TODO: 临时使用，需要定义在常量文件中管理
    public static List<string> AOTMetaAssemblies = new List<string>() {"mscorlib.dll", "System.dll", "System.Core.dll" };
    ...
    [MenuItem("HybridCLR/Build/生成热更DLL.bytes并拷贝到YooAsset对应目录中")]
    ...
    public static void CopyAOTAssembliesToAssetPath()
    {
        ...
        string aotAssembliesDstDir = Application.dataPath +"/"+ BuildDLLCommand.AssemblyTextAssetPath;

        foreach (var dll in BuildDLLCommand.AOTMetaAssemblies)
        {
    ...
    public static void CopyHotUpdateAssembliesToAssetPath()
    {
        ...
        string hotfixAssembliesDstDir = Application.dataPath +"/"+ BuildDLLCommand.AssemblyTextAssetPath;
